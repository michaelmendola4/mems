  ...
  return (
    <SimpleLayout>
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold text-center mb-8 text-primary-700">My Storybook</h1>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-4">
                <h3 className="text-lg font-semibold mb-2">First Day at New Job</h3>
                <p className="text-gray-600 text-sm mb-3 line-clamp-2">
                  Starting my career at the tech company. Met my new team and got my first assignment.
                </p>
                <div className="flex justify-between items-center">
